...
public class HttpResponseFactory {
	...
	public static HttpResponse create304NotModified(String connection) {
		HttpResponse response = new HttpResponse(Protocol.VERSION, Protocol.RESOURCE_NOT_MODIFIED_CODE, 
				Protocol.RESOURCE_NOT_MODIFIED_TEXT, new HashMap<String, String>(), null);
